     ...
     <nav class="sidebar sidebar-offcanvas" id="sidebar">
         <ul class="nav">
             ...
             <!----------------- For Product ----------->
             <li
                 class="nav-item {{ request()->is('products/create') ? 'active' : '' }} {{ request()->is('products') ? 'active' : '' }}">
                 ...
                 <div class="collapse{{ request()->is('products/create') ? 'show' : '' }} {{ request()->is('products') ? 'show' : '' }}"
                     id="produt">
                     <ul class="nav flex-column sub-menu">
                         <li class="nav-item">
                             <a class="nav-link {{ request()->is('products/create') ? 'active' : '' }}"
                                 href="{{ url('/products/create') }}">Add Product</a>
                         </li>
                         <li class="nav-item">
             ...
             <!----------------- For Category ----------->
             <li
                 class="nav-item {{ request()->is('categories/create') ? 'active' : '' }} {{ request()->is('categories') ? 'active' : '' }}">
                 ...
                 <div class="collapse{{ request()->is('categories/create') ? 'show' : '' }} {{ request()->is('categories') ? 'show' : '' }}"
                     id="category">
                     <ul class="nav flex-column sub-menu">
                         <li class="nav-item">
                             <a class="nav-link {{ request()->is('categories/create') ? 'active' : '' }}"
                                 href="{{ url('/categories/create') }}">Add Category</a>
                         </li>
             ...
             <!----------------- For Sub Category ----------->
             <li
                 class="nav-item {{ request()->is('subcategories/create') ? 'active' : '' }} {{ request()->is('subcategories') ? 'active' : '' }}">
                 ...
                 <div class="collapse {{ request()->is('subcategories/create') ? 'show' : '' }} {{ request()->is('subcategories') ? 'show' : '' }}"
                     id="subcat">
                     <ul class="nav flex-column sub-menu">
                         <li class="nav-item">
                             <a class="nav-link {{ request()->is('subcategories/create') ? 'active' : '' }}"
                                 href="{{ url('/subcategories/create') }}">Add Sub Category
                             </a>
                         </li>
                         <li class="nav-item">
             ...
             <!----------------- For Brand ----------->
             <li
                 class="nav-item {{ request()->is('brands/create') ? 'active' : '' }} {{ request()->is('brands') ? 'active' : '' }}">
                 ...
                 <div class="collapse {{ request()->is('brands/create') ? 'show' : '' }} {{ request()->is('brands') ? 'show' : '' }}"
                     id="brand">
                     <ul class="nav flex-column sub-menu">
                         <li class="nav-item">
                             <a class="nav-link {{ request()->is('brands/create') ? 'active' : '' }}"
                                 href="{{ url('/brands/create') }}"> Add Brand</a>
                         </li>
                         <li class="nav-item">
